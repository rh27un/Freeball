...
beta v1.1
CHANGELOG
- alternate assigned teams
- name field is required
- tweaked player and ball physics (PBP)
- goals are no longer considered walls

BUGFIXES
- players are no longer erroneously considered to be on the walls while the game is paused
- UI should reset when game is paused